              ...
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-white/5">
                  {[
                    ...
                    ['size',        'No',  'Gift size (e.g. 3x2.5 in). Same itemCode + different size = size variants on the storefront'],
                    ['itemCode',    'No',  'Design group (stored as design_group). Groups size variants; catalogue filter chips use this key'],
                    ['imageUrl',    'No',  'Full HTTPS URL to product image (stored as image_url)'],
